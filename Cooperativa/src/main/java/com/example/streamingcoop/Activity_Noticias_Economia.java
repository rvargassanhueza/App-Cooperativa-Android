...
public class Activity_Noticias_Economia extends Activity {
    ...
    private String URL = "http://especiales2.cooperativa.cl/noticias/site/tax/port/all/rss_6___1.xml";
    ...
    private void inicializarListView() {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent intent = new Intent(Activity_Noticias_Economia.this, Activity_Articulo.class);
