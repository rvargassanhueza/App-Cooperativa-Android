...
public class Activity_Noticias_Politica extends Activity {
    ...
    private String URL = "http://especiales2.cooperativa.cl/noticias/site/tax/port/all/rss_3_156__1.xml";
    ...
    private void inicializarListView() {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent intent = new Intent(Activity_Noticias_Politica.this, Activity_Articulo.class);
